...
- **Broad** — symbols (functions, classes, methods, types, …) plus name-resolved
  ...
  **Rust, C, C++, C#, Ruby, Scala, Elixir, Solidity,
  OCaml, Zig, Dart, Clojure, Nix, Lua, Gleam** (Gleam resolves better than bare
  names: `import app/thing` settles to the in-repo module, and `thing.helper()`
  is looked up in that module alone — a stdlib call drops rather than colliding
